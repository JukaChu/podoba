...
(function(factory) {
    ...
    $.fn.dateRangePicker = function(opt) {
        ...
        function showSelectedDays() {
            ...
            box.find('.day').each(function() {
                ...
                if (opt.start && moment(start).format('YYYY-MM-DD') == moment(time).format('YYYY-MM-DD')) {
                    ...
                    // $(this).addClass(`${moment(time).format('DD.MM.YYYY')}`);
                    [...document.querySelectorAll('.footer .acc-inputs input')][0].value = moment(time).format('DD.MM.YYYY');
                ...
                if (opt.end && moment(end).format('YYYY-MM-DD') == moment(time).format('YYYY-MM-DD')) {
                    ...
                    // $(this).addClass(`${moment(time).format('DD.MM.YYYY')}`);
                    [...document.querySelectorAll('.footer .acc-inputs input')][1].value = moment(time).format('DD.MM.YYYY');
        ...
        function createDom() {
            ...
            html += '<div class="footer"><div class="acc-inputs"><input type="text" placeholder="От" readonly><input type="text" placeholder="До" readonly></div>';
